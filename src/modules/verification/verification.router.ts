  ...
  try {
    ...
    const result: VerificationResult = {
      ...
      credential: {
        ...
        templateVersionId: cred.templateVersionId,
        designSchema: (cred as any).designSchema || (cred as any).schema || undefined,
        recipient: {
          name: cred.candidateName,
          email: cred.candidateEmail,
          studentId: cred.candidateId
        },
        issuer: {
          name: orgName,
          department: org?.department || 'Academic Department',
          code: orgCode,
          verifiedDomain: org?.domain || 'icertix.com',
          logo: org?.logo || 'IC'
        },
